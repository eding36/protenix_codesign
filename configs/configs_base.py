...
basic_configs = {
    ...
    # 1.0 = uniform (original). <1.0 shifts mass toward FULLY MASKED CDRs, which is
    # the task eval measures. NOTE: seq_t is coupled to the structure noise
    # (sigma = schedule[T-1-seq_t]), so lowering this also shifts structure training
    # toward high sigma.
